 ...
 *
 * <p>变更记录格式：{tileX, tileY, oldType, newType}，
 * 便于服务端逻辑判断破坏（old!=AIR 且 new==AIR）与放置（old==AIR 且 new!=AIR）。</p>
 */
public class ServerInfiniteMap extends InfiniteMap {

    /** 单格方块变更记录：{tileX, tileY, oldType, newType} */
    ...
    public void setTileType(int tileX, int tileY, int type) {
        ...
        tileChanges.add(new int[]{tileX, tileY, oldType, type});
    }
